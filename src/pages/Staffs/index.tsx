            ...
            <TableContainer>
              <table>
                ...
                <tbody>
                    ...
                    <tr >
                      <td className="title"><div><img src={img} alt=""/>
                      Edward Mãos de Tesoura</div></td>
                      <td className="">edward@gobarber.com</td>
                      <td>+55-11-32145-8754</td>
                      <td><div className={classes.root}>
                        <Rating name="half-rating-read" defaultValue={5}
                    ...
                    <tr >
                      <td className="title"><div><img src={img1} alt=""/>
                      Deadpool</div></td>
                      <td className="">dead@gobarber.com</td>
                      <td>+55-11-32145-8754</td>
                      <td><div className={classes.root}>
                        <Rating name="half-rating-read" defaultValue={3.5}
                        precision={0.5} readOnly />
                      </div></td>
                      <td><div><Link to="/staffs/new">
                        <img src={edit} alt=""/>
                    ...
                    <tr >
                      <td className="title"><div><img src={img2} alt=""/>
                      Rocky Balboa</div></td>
                      <td className="">rocky@gobarber.com</td>
                      <td>+55-11-32145-8754</td>
                      <td><div className={classes.root}>
                        <Rating name="half-rating-read" defaultValue={4.5}
                        precision={0.5} readOnly />
                      </div></td>
                      <td><div><Link to="/staffs/new">
                        <img src={edit} alt=""/>
                    ...
                    <tr >
                      <td className="title"><div><img src={img3} alt=""/>
                       Tony Stark</div></td>
